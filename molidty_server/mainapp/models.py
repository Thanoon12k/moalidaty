...
class Budget(models.Model):
    year_month = models.CharField(max_length=7, help_text="Format: YYYY-MM", unique=True,auto_created=True)
...
class Receipt(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super().save(*args, **kwargs)
        budget=Budget.objects.filter(year=self.year, month=self.month).first()
